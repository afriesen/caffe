...
NET_ID=sspn_mbest_adam_dlrn101
...
#    MODEL=${MODEL_DIR}/train.1_iter_10000_lr1e-5_nobf.caffemodel
    #
...
#            MODEL=`ls -t ${MODEL_DIR}/train${FOLD_SUFFIX}_noBF_lr1e-5_iter_*.caffemodel | head -n 1`
            MODEL=`ls -t ${MODEL_DIR}/train${FOLD_SUFFIX}_wBF_lr1e-5_iter_*.caffemodel | head -n 1`
        fi
        #
