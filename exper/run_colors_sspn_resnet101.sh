...
#    DATA_ROOT="/Users/afriesen/proj/sspn/data/iccv09Data/"
	...
	NUM_LABELS=6 # terminals only
#	NUM_LABELS=13 # all symbols
    DATA_ROOT="/Users/afriesen/proj/sspn/generateImages/dataset/"
else
    NUM_LABELS=0
    echo "Wrong exp name"
fi
...
if [ ${RUN_TRAIN} -eq 1 ]; then
    ...
    MODEL=sbd/model/deeplab_resnet101/init.caffemodel
...
#    for TEST_SET in test; do
		...
		mkdir -p ${FEATURE_DIR}/${TEST_SET}/sspn
